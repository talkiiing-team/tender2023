...
export const scenarios: Scenario = {
  ...
  pretrain: {
    ...
    82: ['что такое маф', 'определение маф'],
    83: ['что такое огрн', 'определение огрн'],
    84: ['что такое окпд2', 'определение окпд2'],
    85: ['что такое октмо', 'определение октмо'],
    86: ['что такое опо', 'определение опо'],
    87: ['что такое рпн еис', 'определение рпн еис'],
    88: ['что такое судир', 'определение судир'],
    89: ['что такое судир', 'определение судир'],
    90: ['что такое уаис бу', 'определение уаис бу'],
    91: ['что такое ЭМ МО ЕАСУЗ', 'определение ЭМ МО ЕАСУЗ'],
  },
}
...
export const scenariosAnswer: ScenarioAnswers = {
  ...
  pretrain: formAnswersPretrain(91),
}
